...
def process_simple(ast_node, procedure_name, control_states, gamma, rules,
                   control_point):
    if isinstance(ast_node, c_ast.Return):
        ...
        control_point = process_if_stmt(ast_node, procedure_name, control_states,
                                        gamma, rules, control_point)
        ...
        control_point = process_loop(ast_node, procedure_name, control_states,
                                     gamma, rules, control_point)
